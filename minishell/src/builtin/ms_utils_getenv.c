...
/*   Updated: 2025/06/20 13:12:13 by goteixei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @return A pointer to the value part of the string if found (e.g., "/home/goteixei"),
 *         or NULL if the variable is not found.
 *         NOTE: This function returns a pointer to existing memory within data->envp.
